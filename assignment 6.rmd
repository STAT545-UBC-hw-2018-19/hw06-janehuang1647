...
since the regular expression including the keyword `red` which will matched "flickered".
...
```{r}
temp <- c("banana","apple","strawberry")
str_replace(temp,"(^[a-zA-Z])([a-zA-Z]*)([a-zA-Z]$)", \\3\\2\\1)
